...
% %    visdiff('Cars1_corrected_soln.txt', 'Cars1_corrected.txt');
% 
%    carsCarsCars(cars2);
...
% 
%    carsCarsCars('Carssssss.txt');
%    carsCarsCars_soln('Carssssss.txt');
% %    visdiff('Carssssss_corrected.txt', 'Carssssss_corrected_soln.txt');
% 
%    carsCarsCars('KerchowYouJustGotKerchowed.txt');
%    carsCarsCars_soln('KerchowYouJustGotKerchowed.txt');
% %    visdiff('KerchowYouJustGotKerchowed_corrected.txt', 'KerchowYouJustGotKerchowed_corrected_soln.txt');
% 
%    carsCarsCars('TortureTest.txt');
%    carsCarsCars_soln('TortureTest.txt');
% %    visdiff('TortureTest_corrected.txt', 'TortureTest_corrected_soln.txt');
%
%
%% iAmSpeedRead
%
